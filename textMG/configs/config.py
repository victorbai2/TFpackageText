...
parser.add_argument('--total_examples', type=int, default=100)
...
parser.add_argument('--pretrained_vocab_file', type=str, default="/home/projects/tensorflow_practice/data_classification/chinese_L-12_H-768_A-12/vocab.txt")
parser.add_argument('--do_lower_case', type=bool, default=True)
parser.add_argument('--bert_config_file', type=str, default="/home/projects/tensorflow_practice/data_classification/chinese_L-12_H-768_A-12/bert_config.json")
parser.add_argument('--hidden_size', type=int, default=768)
parser.add_argument('--init_checkpoint', type=str, default="/home/projects/tensorflow_practice/data_classification/chinese_L-12_H-768_A-12/bert_model.ckpt")
